(function() {
  ...
  if (!apps.length) {
    for (var container of containers) {
      container.querySelector('[data-leaflets-slider-widget-id]')
        .setAttribute('class', 'leaflet-slider-app');
      ...
      storeFinderContainer.dataset.leafletsSliderWidgetId = container.querySelector('[data-leaflets-slider-widget-id]')
        .dataset.leafletsSliderWidgetId;
