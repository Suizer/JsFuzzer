...
const Qe = s => new Ze(typeof s == "string" ? s : s + "", void 0, Ie),
  Xe = (s, e) => {
    pe ? s.adoptedStyleSheets = e.map(t => t instanceof CSSStyleSheet ? t : t.styleSheet) : e.forEach(t => {
      const n = document.createElement("style"),
        o = window.litNonce;
      o !== void 0 && n.setAttribute("nonce", o), n.textContent = t.cssText, s.appendChild(n)
    })
  },
  Ce = pe ? s => s : s => s instanceof CSSStyleSheet ? (e => {
    let t = "";
...
class q extends HTMLElement {
  ...
  _$EO(e, t, n = ae) {
    ...
    if (r !== void 0 && n.reflect === !0) {
      const d = ((i = (o = n.converter) === null || o === void 0 ? void 0 : o.toAttribute) !== null && i !== void 0 ? i : ue.toAttribute)(t, n.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$El !== r) {
      const d = i.getPropertyOptions(r),
        l = d.converter,
...
const U = globalThis.trustedTypes,
  ...
  et = `<${qe}>`,
  N = document,
  F = (s = "") => N.createComment(s),
  J = s => s === null || typeof s != "object" && typeof s != "function",
  He = Array.isArray,
  tt = s => He(s) || typeof(s == null ? void 0 : s[Symbol.iterator]) == "function",
  W = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  Ee = /-->/g,
  De = />/g,
  I = RegExp(`>|[ 	
...
\f\r"'\`<>=]|("|')|))|$)`, "g"),
  ...
  ot = (s, e, t) => {
    ...
    if (r === void 0) {
      ...
      i._$litPart$ = r = new Z(e.insertBefore(F(), d), d, void 0, t != null ? t : {})
    }
    return r._$AI(s), r
  },
  H = N.createTreeWalker(N, 129, null, !1),
  st = (s, e) => {
    const t = s.length - 1,
      n = [];
    let o, i = e === 2 ? "<svg>" : "",
    ...
    for (let l = 0; l < t; l++) {
      ...
      let w, p, f = -1,
        v = 0;
      for (; v < c.length && (r.lastIndex = v, p = r.exec(c), p !== null);) v = r.lastIndex, r === W ? p[1] === "!--" ? r = Ee : p[1] !== void 0 ? r = De : p[2] !== void 0 ? (Ue.test(p[2]) && (o = RegExp("</" + p[2], "g")), r = I) : p[3] !== void 0 && (r = I) : r === I ? p[0] === ">" ? (r = o != null ? o : W, f = -1) : p[1] === void 0 ? f = -2 : (f = r.lastIndex - p[2].length, w = p[1], r = p[3] === void 0 ? I : p[3] === '"' ? Le : Te) : r === Le || r === Te ? r = I : r === Ee || r === De ? r = W : (r = I, o = void 0);
      const P = r === I && s[l + 1].startsWith("/>") ? " " : "";
      i += r === W ? c + et : f >= 0 ? (n.push(w), c.slice(0, f) + "$lit$" + c.slice(f) + O + P) : c + O + (f === -2 ? (n.push(void 0), l) : P)
    }
...
function G(s, e, t = s, n) {
  var o, i, r, d;
  if (e === V) return e;
  let l = n !== void 0 ? (o = t._$Cl) === null || o === void 0 ? void 0 : o[n] : t._$Cu;
  const c = J(e) ? void 0 : e._$litDirective$;
  return (l == null ? void 0 : l.constructor) !== c && ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, !1), c === void 0 ? l = void 0 : (l = new c(s), l._$AT(s, t, n)), n !== void 0 ? ((r = (d = t)
    ._$Cl) !== null && r !== void 0 ? r : d._$Cl = [])[n] = l : t._$Cu = l), l !== void 0 && (e = G(s, l._$AS(s, e.values), l, n)), e
}
class it {
  constructor(e, t) {
  ...
  p(e) {
    ...
    const {
      ...
      parts: o
    } = this._$AD, i = ((t = e == null ? void 0 : e.creationScope) !== null && t !== void 0 ? t : N)
      .importNode(n, !0);
    H.currentNode = i;
    let r = H.nextNode(),
      d = 0,
...
class Z {
  constructor(e, t, n, o) {
    var i;
    this.type = 2, this._$AH = b, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = n, this.options = o, this._$C_ = (i = o == null ? void 0 : o.isConnected) === null || i === void 0 || i
  }
  get _$AU() {
    var e, t;
  ...
  _$AI(e, t = this) {
    e = G(this, e, t), J(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== V && this.T(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.k(e) : tt(e) ? this.S(e) : this.T(e)
  }
  j(e, t = this._$AB) {
  ...
  T(e) {
    this._$AH !== b && J(this._$AH) ? this._$AA.nextSibling.data = e : this.k(N.createTextNode(e)), this._$AH = e
  }
  $(e) {
    var t;
    const {
      values: n,
      _$litType$: o
    } = e, i = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = K.createElement(o.h, this.options)), o);
    if (((t = this._$AH) === null || t === void 0 ? void 0 : t._$AD) === i) this._$AH.m(n);
    else {
  ...
  S(e) {
    ...
    const t = this._$AH;
    let n, o = 0;
    for (const i of e) o === t.length ? t.push(n = new Z(this.j(F()), this.j(F()), this, this.options)) : n = t[o], n._$AI(i), o++;
...
class te {
  constructor(e, t, n, o, i) {
    this.type = 1, this._$AH = b, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = i, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1)
  ...
  _$AI(e, t = this, n, o) {
    ...
    let r = !1;
    if (i === void 0) e = G(this, e, t, 0), r = !J(e) || e !== this._$AH && e !== V, r && (this._$AH = e);
    else {
      const d = e;
      let l, c;
      for (e = i[0], l = 0; l < i.length - 1; l++) c = G(this, d[n + l], t, l), c === V && (c = this._$AH[l]), r || (r = !J(c) || c !== this._$AH[l]), c === b ? e = b : e !== b && (e += (c != null ? c : "") + i[l + 1]), this._$AH[l] = c
    }
    r && !o && this.P(e)
  }
  P(e) {
...
class dt extends te {
  ...
  _$AI(e, t = this) {
    var n;
    if ((e = (n = G(this, e, t, 0)) !== null && n !== void 0 ? n : b) === V) return;
    const o = this._$AH,
      i = e === b && o !== b || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive,
      r = e !== b && (o === b || i);
...
z.finalized = !0, z._$litElement$ = !0, (de = globalThis.litElementHydrateSupport) === null || de === void 0 || de.call(globalThis, {
  LitElement: z
});
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ht = s => e => typeof e == "function" ? ((t, n) => (window.customElements.define(t, n), n))(s, e) : ((t, n) => {
  const {
    kind: o,
    elements: i
  } = n;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ut = (s, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? {
  ...e,
  finisher(t) {
...
const pt = ({
  ...
  var o;
  if (n === void 0) {
    const i = (o = t.originalKey) !== null && o !== void 0 ? o : t.key,
      r = e != null ? {
        kind: "method",
        placement: "prototype",
        key: i,
    ...
    return s != null && (r.finisher = function(d) {
      s(d, i)
    }), r
  } {
    const i = t.constructor;
    e !== void 0 && Object.defineProperty(t, n, e(n)), s == null || s(i, n)
  }
};
/**
 * @license
  ...
  return pt({
    descriptor: t => {
      const n = {
        get() {
          var o, i;
          return (i = (o = this.renderRoot) === null || o === void 0 ? void 0 : o.querySelector(s)) !== null && i !== void 0 ? i : null
        },
        enumerable: !0,
        configurable: !0
      };
      if (e) {
        ...
        n.get = function() {
          var i, r;
          return this[o] === void 0 && (this[o] = (r = (i = this.renderRoot) === null || i === void 0 ? void 0 : i.querySelector(s)) !== null && r !== void 0 ? r : null), this[o]
        }
      }
      return n
    }
...
class $ {
  ...
  static getOneTrustConsentCookie() {
    ...
    try {
      ...
      return i ? {
        marketing: i.includes(`${L.marketing}:1`),
        statistics: i.includes(`${L.statistics}:1`),
        preferences: i.includes(`${L.preferences}:1`)
      } : null
    } catch {
      return null
    }
  ...
  static getWindowsConsent() {
    ...
    return $.OneTrustResponse() ? {
      ...
      statistics: (i = window == null ? void 0 : window.OnetrustActiveGroups) == null ? void 0 : i.includes(L.statistics),
  ...
  static onConsent() {
    return new Promise(e => {
      ...
      const d = 30,
        l = () => {
          var p, f, v, P;
          clearTimeout(i), window.removeEventListener("CookieConsentLoad", l), $.OneTrustResponse() ? e({
  ...
  function e(a, u, h) {
    return u && s(a.prototype, u), h && s(a, h), a
  }
  ...
  var Ge = ["addImport", "addPageRule", "addRule", "deleteRule", "insertRule", "removeImport", "removeRule"],
  ...
  function Y(a) {
    ...
    for (var B = 0, oe = h.length; B < oe; B++) {
      var j = d.get(h[B]),
        ...
        ze = p.get(ee);
      if (R.length > 0) {
        for (var ie = ze, Fe = R.length; ie < Fe; ie++) {
          var Se = R[ie],
            Je = Se[0],
            Ke = Se[1];
      ...
      for (var u = 0, h = a.length; u < h; u++) {
        ...
        if (!t)
          for (var S = 0, B = _.length; S < B; S++)
            for (var oe = document.createNodeIterator(_[S], NodeFilter.SHOW_ELEMENT, function(se) {
                var R = c.get(se);
  ...
  function be() {
    ...
    for (var y = 0, C = i.length; y < C; y++) Y(i[y]);
  ...
  me(P.prototype), window.CSSStyleSheet = X, We(), ge() ? document.addEventListener("DOMContentLoaded", be) : be()
})();
...
var _t = Object.defineProperty,
  ...
  A = (s, e, t, n) => {
    for (var o = n > 1 ? void 0 : n ? mt(e, t) : e, i = s.length - 1, r; i >= 0; i--)(r = s[i]) && (o = (n ? r(e, t, o) : r(o)) || o);
...
let k = class extends z {
  constructor() {
    super(...arguments), this.tagText = "Ads", this.showTag = !0, this.size = "large", this.title = "", this.showLoading = !1, this.debug = !1, this.adsData = null, this.requestData = "", this._showNewDesign = !1, this._showBanner = !1, this._showSkeleton = !1, this._mql = window.matchMedia && window.matchMedia("(max-width: 600px)"), this._debugCookie = !1, this._debugInstanceId = this.generateSecureRandomNumber(0, 1e3), this._requestInProgress = !1, this._toggleDesign = s => {
      this.consoleDebugLog("_toggleDesign", s), this._showNewDesign = s && s.matches
    }
  }
  static get styles() {
    return [Ne]
  ...
  consoleDebugLog(s, e) {
    ...
    console.log(this._debugInstanceId + ": ", s + " - ", t)
  }
  adsTagTemplate() {
    return E`
      <div class="ads-tag">
  ...
  updated(s) {
    if (this.consoleDebugLog("updated called", s), s.has("requestData")) {
      const e = s.get("requestData");
  ...
  setAdSessionId() {
    ...
    let e = new Array(36),
      t = 0,
      n;
    for (let r = 0; r < 36; r++) r === 8 || r === 13 || r === 18 || r === 23 ? e[r] = "-" : r === 14 ? e[r] = "4" : (t <= 2 && (t = 33554432 + this.generateSecureRandomNumber(0, 16777216 - 1)), n = t & 15, t = t >> 4, e[r] = s[r === 19 ? n & 3 | 8 : n]);
    const o = e.join(""),
      i = "; max-age=" + 24 * 60 * 60 * 730;
    return document.cookie = "adSessionId=" + o + i + "; secure; path=/", o
  }
  fetchWithTimeout(s, e = {}, t = 5e3) {
    let n = {
        ...e
      },
      o = null;
    ...
    return fetch(s, n)
      .then(i => {
        if (this.consoleDebugLog("fetchWithTimeout response ok", i.ok), o && clearTimeout(o), !i.ok) throw new Error(`${i.status}: ${i.statusText}`);
        return i
      })
      .catch(i => {
        throw this.consoleDebugLog("fetchWithTimeout response error", i), o && clearTimeout(o), this._showSkeleton = !1, i.name === "AbortError" ? new Error("Response timed out") : new Error(i.message)
      })
  }
  async _getAd() {
    var s;
    try {
      ...
      if (this._showSkeleton = !1, this._requestInProgress = !1, n.ok && n.status === 200) {
        if (this.consoleDebugLog("_getAd resp.ok"), this._pqData = await n.json()
          .then(o => o[0]), this.consoleDebugLog("_getAd PqData", this._pqData), !(this._pqData && ((s = this._pqData) == null ? void 0 : s.clickthru))) return;
          ...
          const l = new IntersectionObserver(c => {
            c.forEach(w => {
              ...
              if (this.consoleDebugLog(`isIntersecting: ${w.isIntersecting}, Ratio:${p}, Time: ${f}`), !w.isIntersecting) {
                i && (i = 0), d && (clearTimeout(d), d = void 0), r = !1;
                return
              }
              p > 45 && (i || (this.consoleDebugLog(" Start counting ", i), i = f), this.consoleDebugLog("Passed 50%"), r = !0, d || (d = setTimeout(() => {
                this.consoleDebugLog("Send impression timeout"), this._bannerAdsView(), l.unobserve(this.hostElement)
              }, 1e3))), f - i >= 1e3 && r && (d && (clearTimeout(d), d = void 0), this.consoleDebugLog("Send impression intersection"), this._bannerAdsView(), l.unobserve(this.hostElement))
            })
          }, {
            root: null,
            rootMargin: "0px",
  ...
  _onClickImpression() {
    ...
    const s = ((t = this._pqData) == null ? void 0 : t.clickthru) || "";
    window.dataLayerService.push({
      ...
      collections: {
        ...
        click: {
          linkName: "banner-ads",
          linkType: /^(#|\/)/.test(s) || s.indexOf(window.location.hostname) > -1 ? "internal" : "external",
  ...
  generateSecureRandomNumber(s, e) {
    const t = e - s,
      n = Math.ceil(Math.log2(t + 1) / 8),
      o = new Uint8Array(n);
    return crypto.getRandomValues(o), parseInt(o.join(""), 10) % (t + 1) + s
  }
};
A([x({
  type: String
...
A([x({
  type: String,
  converter: {
    fromAttribute: s => s && JSON.parse(decodeURI(s))
  }
})], k.prototype, "adsData", 2);
A([x({
  type: String,
  converter: {
    fromAttribute: s => s && decodeURI(s)
  }
