...
function N(s, e, t = s, n) {
  ...
  return (l == null ? void 0 : l.constructor) !== c && ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, !1), c === void 0 ? l = void 0 : (l = new c(s), l._$AT(s, t, n)), n !== void 0 ? ((r = (d = t)
    ._$Cl) !== null && r !== void 0 ? r : d._$Cl = [])[n] = l : t._$Cu = l), l !== void 0 && (e = N(s, l._$AS(s, e.values), l, n)), e
}
class it {
  constructor(e, t) {
  ...
  p(e) {
    ...
    const {
      ...
      parts: o
    } = this._$AD, i = ((t = e == null ? void 0 : e.creationScope) !== null && t !== void 0 ? t : G)
      .importNode(n, !0);
    H.currentNode = i;
    let r = H.nextNode(),
      d = 0,
...
class te {
  ...
  _$AI(e, t = this, n, o) {
    ...
    let r = !1;
    if (i === void 0) e = N(this, e, t, 0), r = !J(e) || e !== this._$AH && e !== V, r && (this._$AH = e);
    else {
      const d = e;
      let l, c;
      for (e = i[0], l = 0; l < i.length - 1; l++) c = N(this, d[n + l], t, l), c === V && (c = this._$AH[l]), r || (r = !J(c) || c !== this._$AH[l]), c === b ? e = b : e !== b && (e += (c != null ? c : "") + i[l + 1]), this._$AH[l] = c
    }
    r && !o && this.P(e)
  }
  P(e) {
...
let k = class extends B {
  ...
  setAdSessionId() {
    ...
    let e = new Array(36),
      t = 0,
      n;
    for (let r = 0; r < 36; r++) r === 8 || r === 13 || r === 18 || r === 23 ? e[r] = "-" : r === 14 ? e[r] = "4" : (t <= 2 && (t = 33554432 + Math.random() * 16777216 | 0), n = t & 15, t = t >> 4, e[r] = s[r === 19 ? n & 3 | 8 : n]);
    const o = e.join(""),
