...
(async function() {
  ...
  const v = window.location.href.match(/(qa.lidl.de|www.lidl.de)/),
    ...
    t = () => {
      const {
        pathname: l
      } = window.location, r = l.match(/(\/u\/|\/p\/|\/c\/|\/$)/), a = e.some(d => l.indexOf(d) !== -1);
      return r && !a
    },
    w = (l, r, a, d, o, p, i) => {
      o = "batchSDK", l[o] = l[o] || function() {
        (l[o].q = l[o].q || [])
        .push(arguments)
      }, p = r.createElement(a), i = r.getElementsByTagName(a)[0], p.async = !0, p.src = d, i.parentNode.insertBefore(p, i)
    };
  if (!c || c && !v) return;
