...
const Xe = n => new Qe(typeof n == "string" ? n : n + "", void 0, Me),
  Ye = (n, e) => {
...
const Ae = window.trustedTypes,
  et = Ae ? Ae.emptyScript : "",
  Pe = window.reactiveElementPolyfillSupport,
  ce = {
    toAttribute(n, e) {
      switch (e) {
        case Boolean:
...
class L extends HTMLElement {
  ...
  _$EO(e, t, o = re) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const p = ((r = (i = o.converter) === null || i === void 0 ? void 0 : i.toAttribute) !== null && r !== void 0 ? r : ce.toAttribute)(t, o.type);
  ...
  requestUpdate(e, t, o) {
    ...
    e !== void 0 && (((o = o || this.constructor.getPropertyOptions(e))
      .hasChanged || Ie)(this[e], t) ? (this._$AL.has(e) || this._$AL.set(e, t), o.reflect === !0 && this._$El !== e && (this._$EC === void 0 && (this._$EC = new Map), this._$EC.set(e, o))) : i = !1), !this.isUpdatePending && i && (this._$E_ = this._$Ej())
  }
  async _$Ej() {
...
L.finalized = !0, L.elementProperties = new Map, L.elementStyles = [], L.shadowRootOptions = {
    mode: "open"
  }, Pe == null || Pe({
    ReactiveElement: L
  }), ((ie = globalThis.reactiveElementVersions) !== null && ie !== void 0 ? ie : globalThis.reactiveElementVersions = [])
  .push("1.3.4");
/**
 * @license
 * Copyright 2017 Google LLC
...
const I = globalThis.trustedTypes,
  ...
  Ue = Array.isArray,
  ot = n => Ue(n) || typeof(n == null ? void 0 : n[Symbol.iterator]) == "function",
  z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  Ee = /-->/g,
  xe = />/g,
  O = RegExp(`>|[ 	
...
\f\r"'\`<>=]|("|')|))|$)`, "g"),
  De = /'/g,
  Te = /"/g,
  qe = /^(?:script|style|textarea|title)$/i,
  nt = n => (e, ...t) => ({
    _$litType$: n,
    strings: e,
    values: t
  ...
  it = (n, e, t) => {
    ...
    let s = r._$litPart$;
    if (s === void 0) {
      const p = (i = t == null ? void 0 : t.renderBefore) !== null && i !== void 0 ? i : null;
  ...
  rt = (n, e) => {
    ...
    for (let l = 0; l < t; l++) {
      ...
      let $, f, _ = -1,
        y = 0;
      for (; y < h.length && (s.lastIndex = y, f = s.exec(h), f !== null);) y = s.lastIndex, s === z ? f[1] === "!--" ? s = Ee : f[1] !== void 0 ? s = xe : f[2] !== void 0 ? (qe.test(f[2]) && (i = RegExp("</" + f[2], "g")), s = O) : f[3] !== void 0 && (s = O) : s === O ? f[0] === ">" ? (s = i != null ? i : z, _ = -1) : f[1] === void 0 ? _ = -2 : (_ = s.lastIndex - f[2].length, $ = f[1], s = f[3] === void 0 ? O : f[3] === '"' ? Te : De) : s === Te || s === De ? s = O : s === Ee || s === xe ? s = z : (s = O, i = void 0);
      const P = s === O && n[l + 1].startsWith("/>") ? " " : "";
      r += s === z ? h + tt : _ >= 0 ? (o.push($), h.slice(0, _) + "$lit$" + h.slice(_) + T + P) : h + T + (_ === -2 ? (o.push(void 0), l) : P)
    }
    const p = r + (n[t] || "<?>") + (e === 2 ? "</svg>" : "");
    if (!Array.isArray(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
    return [ke !== void 0 ? ke.createHTML(p) : p, o]
  };
class F {
  constructor({
    strings: e,
    ...
    if (this.el = F.createElement(h, o), M.currentNode = this.el.content, t === 2) {
      const f = this.el.content,
        _ = f.firstChild;
      _.remove(), f.append(..._.childNodes)
    }
    for (;
      (i = M.nextNode()) !== null && l.length < p;) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) {
          const f = [];
            ...
            if (_.endsWith("$lit$") || _.startsWith(T)) {
              ...
              if (f.push(_), y !== void 0) {
                ...
                l.push({
                  ...
                  name: x[2],
                  strings: P,
                  ctor: x[1] === "." ? at : x[1] === "?" ? dt : x[1] === "@" ? ht : ee
                })
              } else l.push({
                type: 6,
                index: r
              })
            } for (const _ of f) i.removeAttribute(_)
        }
        if (qe.test(i.tagName)) {
          const f = i.textContent.split(T),
            _ = f.length - 1;
          if (_ > 0) {
            i.textContent = I ? I.emptyScript : "";
            for (let y = 0; y < _; y++) i.append(f[y], N()), M.nextNode(), l.push({
              type: 2,
              index: ++r
            });
            i.append(f[_], N())
        ...
        if (i.data === He) l.push({
          ...
          let f = -1;
          for (;
            (f = i.data.indexOf(T, f + 1)) !== -1;) l.push({
            type: 7,
            index: r
          }), f += T.length - 1
        } r++
...
function q(n, e, t = n, o) {
  ...
  return (l == null ? void 0 : l.constructor) !== h && ((r = l == null ? void 0 : l._$AO) === null || r === void 0 || r.call(l, !1), h === void 0 ? l = void 0 : (l = new h(n), l._$AT(n, t, o)), o !== void 0 ? ((s = (p = t)
    ._$Cl) !== null && s !== void 0 ? s : p._$Cl = [])[o] = l : t._$Cu = l), l !== void 0 && (e = q(n, l._$AS(n, e.values), l, o)), e
}
class st {
  constructor(e, t) {
  ...
  p(e) {
    ...
    for (; h !== void 0;) {
      if (p === h.index) {
        let $;
        h.type === 2 ? $ = new K(s, s.nextSibling, this, e) : h.type === 1 ? $ = new h.ctor(s, h.name, h.strings, this, e) : h.type === 6 && ($ = new ct(s, this, e)), this.v.push($), h = i[++l]
      }
...
class K {
  constructor(e, t, o, i) {
    var r;
    this.type = 2, this._$AH = b, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = o, this.options = i, this._$C_ = (r = i == null ? void 0 : i.isConnected) === null || r === void 0 || r
  }
  get _$AU() {
    var e, t;
  ...
  _$AI(e, t = this) {
    e = q(this, e, t), W(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== U && this.T(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.k(e) : ot(e) ? this.S(e) : this.T(e)
  }
  j(e, t = this._$AB) {
  ...
  T(e) {
    this._$AH !== b && W(this._$AH) ? this._$AA.nextSibling.data = e : this.k(H.createTextNode(e)), this._$AH = e
  }
  $(e) {
    var t;
    const {
  ...
  _$AC(e) {
    ...
    return t === void 0 && Re.set(e.strings, t = new F(e)), t
  }
  S(e) {
...
class ee {
  constructor(e, t, o, i, r) {
    this.type = 1, this._$AH = b, this._$AN = void 0, this.element = e, this.name = t, this._$AM = i, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1)
  ...
  _$AI(e, t = this, o, i) {
    ...
    if (r === void 0) e = q(this, e, t, 0), s = !W(e) || e !== this._$AH && e !== U, s && (this._$AH = e);
      ...
      const p = e;
      let l, h;
      for (e = r[0], l = 0; l < r.length - 1; l++) h = q(this, p[o + l], t, l), h === U && (h = this._$AH[l]), s || (s = !W(h) || h !== this._$AH[l]), h === b ? e = b : e !== b && (e += (h != null ? h : "") + r[l + 1]), this._$AH[l] = h
    }
    s && !i && this.P(e)
  }
  P(e) {
...
class ht extends ee {
  ...
  _$AI(e, t = this) {
    var o;
    if ((e = (o = q(this, e, t, 0)) !== null && o !== void 0 ? o : b) === U) return;
    const i = this._$AH,
      r = e === b && i !== b || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive,
      s = e !== b && (i === b || r);
...
Oe == null || Oe(F, K), ((se = globalThis.litHtmlVersions) !== null && se !== void 0 ? se : globalThis.litHtmlVersions = [])
  .push("2.2.7");
/**
 * @license
 * Copyright 2017 Google LLC
...
V.finalized = !0, V._$litElement$ = !0, (ae = globalThis.litElementHydrateSupport) === null || ae === void 0 || ae.call(globalThis, {
  LitElement: V
});
...
((le = globalThis.litElementVersions) !== null && le !== void 0 ? le : globalThis.litElementVersions = [])
.push("3.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pt = n => e => typeof e == "function" ? ((t, o) => (window.customElements.define(t, o), o))(n, e) : ((t, o) => {
  const {
    kind: i,
    elements: r
  } = o;
...
const ft = ({
  ...
  if (o === void 0) {
    ...
    return n != null && (s.finisher = function(p) {
      n(p, r)
    }), s
  } {
...
class J {
  ...
  static onConsent() {
    return new Promise(e => {
      ...
      const t = J.getConsentCookie(),
        i = (($ = window == null ? void 0 : window.Cookiebot) != null && $.hasResponse ? (f = window == null ? void 0 : window.Cookiebot) == null ? void 0 : f.consent : void 0) || t;
      if (i) {
        e(i);
        return
      }
      ...
      const p = 30,
        l = () => {
          var _;
          clearTimeout(r), window.removeEventListener("CookiebotOnLoad", l), e((_ = window == null ? void 0 : window.Cookiebot) == null ? void 0 : _.consent)
        },
        h = () => {
          var y, P, x;
  ...
  function je(a, c) {
    ...
    if (!a.every(ye)) throw new TypeError("Failed to set the 'adoptedStyleSheets' property on " + d + ": Failed to convert value to 'CSSStyleSheet'");
    var u = a.filter(function(v, g) {
      return a.indexOf(v) === g
    });
    return s.set(c, u), u
  }
  ...
  var Q = function() {
    function a() {
      ...
      _.loaded ? y.body.appendChild(d) : (document.head.appendChild(d), d.disabled = !0, o.push(d)), p.set(this, {
        adopters: new Map,
        actions: [],
        basicStyleElement: d
      })
    ...
    return c.replace = function(u) {
      ...
      try {
        ...
        var g = p.get(this),
          m = g.basicStyleElement;
        return m.innerHTML = v, me(this), Promise.resolve(this)
      } catch (S) {
      ...
      var g = p.get(this),
        m = g.basicStyleElement;
      return m.innerHTML = v, me(this), this
    }, e(a, [{
      key: "cssRules",
      get: function() {
        if (!p.has(this)) throw new TypeError(Z);
        var u = p.get(this),
          v = u.basicStyleElement;
        return v.sheet.cssRules
      }
    }]), a
  }();
  ze.forEach(function(a) {
    Q.prototype[a] = function() {
      ...
      var c = arguments,
        ...
        u = d.adopters,
        v = d.actions,
        g = d.basicStyleElement,
        m = g.sheet[a].apply(g.sheet, c);
      return u.forEach(function(S) {
        S.sheet && S.sheet[a].apply(S.sheet, c)
      }), v.push([a, c]), m
    }
  });
  ...
  function X(a) {
    for (var c = document.createDocumentFragment(), d = _e(a), u = $.get(a), v = 0, g = d.length; v < g; v++) {
      var m = p.get(d[v]),
        S = m.adopters,
        k = m.basicStyleElement,
        w = S.get(a);
      w ? (u.disconnect(), c.appendChild(w), (!w.innerHTML || w.sheet && !w.sheet.cssText) && (w.innerHTML = k.innerHTML), u.observe()) : (w = document.createElement("style"), w.innerHTML = k.innerHTML, l.set(w, a), f.set(w, 0), S.set(a, w), c.appendChild(w)), a === document.head && i.push(w)
    }
    a.insertBefore(c, a.lastChild);
    for (var B = 0, te = d.length; B < te; B++) {
      var j = p.get(d[B]),
        oe = j.adopters,
        R = j.actions,
        Y = oe.get(a),
        We = f.get(Y);
      if (R.length > 0) {
        for (var ne = We, Fe = R.length; ne < Fe; ne++) {
          var $e = R[ne],
            Je = $e[0],
            Ke = $e[1];
  ...
  function Ge(a, c) {
    for (var d = _e(a), u = 0, v = c.length; u < v; u++)
      if (!(d.indexOf(c[u]) > -1)) {
        var g = p.get(c[u]),
          m = g.adopters,
          S = $.get(a),
          k = m.get(a);
        k || (k = m.get(document.head)), S.disconnect(), k.parentNode.removeChild(k), S.observe()
      }
  }
  ...
  function Ve(a) {
    if (!!document)
      for (var c = 0, d = a.length; c < d; c++) {
        for (var u = a[c], v = u.addedNodes, g = u.removedNodes, m = 0, S = g.length; m < S; m++) {
          var k = l.get(g[m]);
          k && X(k)
        }
        if (!t)
          for (var w = 0, B = v.length; w < B; w++)
            for (var te = document.createNodeIterator(v[w], NodeFilter.SHOW_ELEMENT, function(oe) {
                var R = h.get(oe);
                return R && R.adoptedStyleSheets.length > 0 ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT
              }, null, !1), j = void 0; j = te.nextNode();) X(h.get(j))
      }
  }

  function be(a) {
    var c = new MutationObserver(Ve),
      d = {
        observe: function() {
          c.observe(a, {
            childList: !0,
  ...
  function we() {
    ...
    a.hidden = !0, document.body.appendChild(a), y.body = a.contentWindow.document.body, y.CSSStyleSheet = a.contentWindow.CSSStyleSheet, ge(a.contentWindow.CSSStyleSheet.prototype), be(document.body), _.loaded = !0;
    for (var c = document.createDocumentFragment(), d = 0, u = o.length; d < u; d++) o[d].disabled = !1, c.appendChild(o[d]);
    y.body.appendChild(c);
    for (var v = 0, g = i.length; v < g; v++) c.appendChild(i[v]);
    document.body.insertBefore(c, document.body.firstChild);
    for (var m = 0, S = r.length; m < S; m++) X(r[m]);
  ...
  function Ne() {
    var a = {
      ...
      set: function(u) {
        var v = s.get(this) || [];
        je(u, this);
        var g = this === document ? fe() ? this.head : this.body : this,
          m = "isConnected" in g ? g.isConnected : document.body.contains(g);
...
let C = class extends V {
  ...
  async connectedCallback() {
    super.connectedCallback(), this.consent = this.debug ? {
      marketing: !0
    } : await J.onConsent(), !(!this.consent || this.consent && !this.consent.marketing) && (await this._getAd(), this._toggleDesign(he), he.addEventListener("change", this._toggleDesign))
  }
  disconnectedCallback() {
    super.disconnectedCallback(), he.removeEventListener("change", this._toggleDesign)
  }
  async updated(n) {
    if (n.has("requestData")) {
      const e = n.get("requestData");
      this.requestData && this.requestData !== e && await this._getAd()
    }
  }
  render() {
    return E`
  ...
  async _getAd() {
    var n;
    try {
      if (!this.requestData || !this.consent || this.consent && !this.consent.marketing) return;
      const e = J.getCookieValue("adSessionId") || this.setAdSessionId(),
        t = JSON.parse(this.requestData);
      t.session = e;
      const o = await fetch("/t/piq/request", {
        method: "POST",
      ...
      if (o.ok && o.status === 200) {
        ...
        this._showBanner = !0, this._bannerAdsImpression()
      }
    } catch (e) {
      console.log(e)
    }
...
A([ue()], C.prototype, "_pqData", 2);
A([ue()], C.prototype, "_showNewDesign", 2);
A([ue()], C.prototype, "_showBanner", 2);
A([_t("#tooltip")], C.prototype, "tooltip", 2);
C = A([pt("banner-ads")], C);