...
\f\r"'\`<>=]|("|')|))|$)`, "g"),
  ...
  st = (s, e) => {
    ...
    for (let l = 0; l < t; l++) {
      ...
      let w, p, _ = -1,
        v = 0;
      for (; v < c.length && (r.lastIndex = v, p = r.exec(c), p !== null);) v = r.lastIndex, r === z ? p[1] === "!--" ? r = Ee : p[1] !== void 0 ? r = De : p[2] !== void 0 ? (Ue.test(p[2]) && (o = RegExp("</" + p[2], "g")), r = I) : p[3] !== void 0 && (r = I) : r === I ? p[0] === ">" ? (r = o != null ? o : z, _ = -1) : p[1] === void 0 ? _ = -2 : (_ = r.lastIndex - p[2].length, w = p[1], r = p[3] === void 0 ? I : p[3] === '"' ? Le : Te) : r === Le || r === Te ? r = I : r === Ee || r === De ? r = z : (r = I, o = void 0);
      const P = r === I && s[l + 1].startsWith("/>") ? " " : "";
      i += r === z ? c + et : _ >= 0 ? (n.push(w), c.slice(0, _) + "$lit$" + c.slice(_) + O + P) : c + O + (_ === -2 ? (n.push(void 0), l) : P)
    }
      ...
      if (o.nodeType === 1) {
        if (o.hasAttributes()) {
          ...
          for (const _ of o.getAttributeNames())
            ...
            } for (const _ of p) o.removeAttribute(_)
        }
        if (Ue.test(o.tagName)) {
          ...
          if (_ > 0) {
            ...
            for (let v = 0; v < _; v++) o.append(p[v], F()), H.nextNode(), l.push({
              type: 2,
              index: ++i
            });
            o.append(p[_], F())
...
class Z {
  ...
  _$AI(e, t = this) {
    e = G(this, e, t), J(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== N && this.T(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.k(e) : tt(e) ? this.S(e) : this.T(e)
  }
  j(e, t = this._$AB) {
...
class te {
  ...
  _$AI(e, t = this, n, o) {
    ...
    let r = !1;
    if (i === void 0) e = G(this, e, t, 0), r = !J(e) || e !== this._$AH && e !== N, r && (this._$AH = e);
    else {
      const d = e;
      let l, c;
      for (e = i[0], l = 0; l < i.length - 1; l++) c = G(this, d[n + l], t, l), c === N && (c = this._$AH[l]), r || (r = !J(c) || c !== this._$AH[l]), c === b ? e = b : e !== b && (e += (c != null ? c : "") + i[l + 1]), this._$AH[l] = c
    }
    r && !o && this.P(e)
  }
  P(e) {
...
class dt extends te {
  ...
  _$AI(e, t = this) {
    var n;
    if ((e = (n = G(this, e, t, 0)) !== null && n !== void 0 ? n : b) === N) return;
    const o = this._$AH,
...
class $ {
  ...
  function Y(a) {
    ...
    for (var B = 0, oe = h.length; B < oe; B++) {
      var W = d.get(h[B]),
        ...
        je = p.get(ee);
      if (R.length > 0) {
        for (var ie = je, Fe = R.length; ie < Fe; ie++) {
          var Se = R[ie],
            Je = Se[0],
            Ke = Se[1];
  ...
  function We(a) {
    if (!!document)
      for (var u = 0, h = a.length; u < h; u++) {
        for (var g = a[u], f = g.addedNodes, m = g.removedNodes, y = 0, C = m.length; y < C; y++) {
          var D = l.get(m[y]);
          D && Y(D)
        }
        if (!t)
  ...
  function be() {
    ...
    for (var f = 0, m = o.length; f < m; f++) u.appendChild(o[f]);
        ...
        this._showBanner = !0, setTimeout(() => {
          ...
          const l = new IntersectionObserver(c => {
            c.forEach(w => {
              ...
              p > 45 && (i || (this.consoleDebugLog(" Start counting ", i), i = _), this.consoleDebugLog("Passed 50%"), r = !0, d || (d = setTimeout(() => {
                this.consoleDebugLog("Send impression timeout"), this._bannerAdsView(), l.unobserve(this.hostElement)
              }, 1e3))), _ - i >= 1e3 && r && (d && (clearTimeout(d), d = void 0), this.consoleDebugLog("Send impression intersection"), this._bannerAdsView(), l.unobserve(this.hostElement))
            })
          }, {
            root: null,
            rootMargin: "0px",
