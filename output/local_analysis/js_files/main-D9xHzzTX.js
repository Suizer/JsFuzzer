...
const {
  ...
  getPrototypeOf: Re
} = Object, k = globalThis, le = k.trustedTypes, Oe = le ? le.emptyScript : "", Y = k.reactiveElementPolyfillSupport, B = (t, e) => t, K = {
  toAttribute(t, e) {
    switch (e) {
      case Boolean:
        t = t ? Oe : null;
...
Symbol.metadata ?? (Symbol.metadata = Symbol("metadata")), k.litPropertyMetadata ?? (k.litPropertyMetadata = new WeakMap);
...
I.elementStyles = [], I.shadowRootOptions = {
    ...
    ReactiveElement: I
  }), (k.reactiveElementVersions ?? (k.reactiveElementVersions = []))
  .push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
...
const Ue = (t, e) => {
  ...
  for (let l = 0; l < o; l++) {
    ...
    let c, _, d = -1,
      h = 0;
    for (; h < a.length && (r.lastIndex = h, _ = r.exec(a), _ !== null);) h = r.lastIndex, r === O ? _[1] === "!--" ? r = he : _[1] !== void 0 ? r = ue : _[2] !== void 0 ? (Ce.test(_[2]) && (i = RegExp("</" + _[2], "g")), r = $) : _[3] !== void 0 && (r = $) : r === $ ? _[0] === ">" ? (r = i ?? O, d = -1) : _[1] === void 0 ? d = -2 : (d = r.lastIndex - _[2].length, c = _[1], r = _[3] === void 0 ? $ : _[3] === '"' ? pe : _e) : r === pe || r === _e ? r = $ : r === he || r === ue ? r = O : (r = $, i = void 0);
    const w = r === $ && t[l + 1].startsWith("/>") ? " " : "";
    n += r === O ? a + Be : d >= 0 ? (s.push(c), a.slice(0, d) + be + a.slice(d) + C + w) : a + C + (d === -2 ? l : w)
  }
  return [ke(t, n + (t[o] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), s]
};
class W {
  constructor({
    strings: e,
    ...
    for (;
      ...
      if (i.nodeType === 1) {
        ...
        if (i.data === ve) a.push({
          ...
          let d = -1;
          for (;
            (d = i.data.indexOf(C, d + 1)) !== -1;) a.push({
            type: 7,
            index: n
          }), d += C.length - 1
        } n++
...
class G {
  ...
  $(e) {
    ...
    const {
      values: o,
      _$litType$: s
    } = e, i = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = W.createElement(ke(s.h, s.h[0]), this.options)), s);
