...
const Xe = n => new Qe(typeof n == "string" ? n : n + "", void 0, Me),
  ...
  Ce = ue ? n => n : n => n instanceof CSSStyleSheet ? (e => {
    let t = "";
...
class L extends HTMLElement {
  ...
  _$EO(e, t, o = re) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const u = ((r = (i = o.converter) === null || i === void 0 ? void 0 : i.toAttribute) !== null && r !== void 0 ? r : ce.toAttribute)(t, o.type);
      this._$El = e, u == null ? this.removeAttribute(s) : this.setAttribute(s, u), this._$El = null
    }
  }
  _$AK(e, t) {
    var o, i;
...
\f\r"'\`<>=]|("|')|))|$)`, "g"),
  ...
  it = (n, e, t) => {
    ...
    if (s === void 0) {
      ...
      r._$litPart$ = s = new K(e.insertBefore(N(), u), u, void 0, t != null ? t : {})
    }
    return s._$AI(n), s
  },
  ...
  rt = (n, e) => {
    ...
    for (let l = 0; l < t; l++) {
      ...
      let $, f, g = -1,
        y = 0;
      for (; y < h.length && (s.lastIndex = y, f = s.exec(h), f !== null);) y = s.lastIndex, s === z ? f[1] === "!--" ? s = Ee : f[1] !== void 0 ? s = xe : f[2] !== void 0 ? (qe.test(f[2]) && (i = RegExp("</" + f[2], "g")), s = O) : f[3] !== void 0 && (s = O) : s === O ? f[0] === ">" ? (s = i != null ? i : z, g = -1) : f[1] === void 0 ? g = -2 : (g = s.lastIndex - f[2].length, $ = f[1], s = f[3] === void 0 ? O : f[3] === '"' ? De : Te) : s === De || s === Te ? s = O : s === Ee || s === xe ? s = z : (s = O, i = void 0);
      const P = s === O && n[l + 1].startsWith("/>") ? " " : "";
      r += s === z ? h + tt : g >= 0 ? (o.push($), h.slice(0, g) + "$lit$" + h.slice(g) + D + P) : h + D + (g === -2 ? (o.push(void 0), l) : P)
    }
    const u = r + (n[t] || "<?>") + (e === 2 ? "</svg>" : "");
    if (!Array.isArray(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
    return [ke !== void 0 ? ke.createHTML(u) : u, o]
  };
class F {
  constructor({
    strings: e,
...
function q(n, e, t = n, o) {
  ...
  return (l == null ? void 0 : l.constructor) !== h && ((r = l == null ? void 0 : l._$AO) === null || r === void 0 || r.call(l, !1), h === void 0 ? l = void 0 : (l = new h(n), l._$AT(n, t, o)), o !== void 0 ? ((s = (u = t)
    ._$Cl) !== null && s !== void 0 ? s : u._$Cl = [])[o] = l : t._$Cu = l), l !== void 0 && (e = q(n, l._$AS(n, e.values), l, o)), e
}
class st {
  constructor(e, t) {
  ...
  p(e) {
    ...
    for (; h !== void 0;) {
      ...
      u !== (h == null ? void 0 : h.index) && (s = M.nextNode(), u++)
    }
    return r
  }
  m(e) {
...
class K {
  ...
  _$AI(e, t = this) {
    e = q(this, e, t), W(e) ? e === w || e == null || e === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : e !== this._$AH && e !== U && this.T(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.k(e) : ot(e) ? this.S(e) : this.T(e)
  }
  j(e, t = this._$AB) {
...
class ee {
  ...
  _$AI(e, t = this, o, i) {
    ...
    if (r === void 0) e = q(this, e, t, 0), s = !W(e) || e !== this._$AH && e !== U, s && (this._$AH = e);
      ...
      const u = e;
      let l, h;
      for (e = r[0], l = 0; l < r.length - 1; l++) h = q(this, u[o + l], t, l), h === U && (h = this._$AH[l]), s || (s = !W(h) || h !== this._$AH[l]), h === w ? e = w : e !== w && (e += (h != null ? h : "") + r[l + 1]), this._$AH[l] = h
    }
    s && !i && this.P(e)
  }
  P(e) {
...
class dt extends ee {
  ...
  P(e) {
    e && e !== w ? this.element.setAttribute(this.name, lt) : this.element.removeAttribute(this.name)
  }
}
class ht extends ee {
  constructor(e, t, o, i, r) {
...
const ft = ({
  ...
  if (o === void 0) {
    ...
    return n != null && (s.finisher = function(u) {
      n(u, r)
    }), s
  } {
...
class J {
  ...
  static onConsent() {
    return new Promise(e => {
      ...
      const u = 30,
        ...
        h = () => {
          var y, P, x;
          if (!((y = window == null ? void 0 : window.Cookiebot) == null ? void 0 : y.consent) && s < u) {
  ...
  function je(a, c) {
    ...
    var p = a.filter(function(_, v) {
      return a.indexOf(_) === v
    });
    return s.set(c, p), p
  }
  ...
  function _e(a) {
    ...
    var c = a.match(x) || [],
      d = a;
    return c.length && (console.warn("@import rules are not allowed here. See https://github.com/WICG/construct-stylesheets/issues/119#issuecomment-588352418"), c.forEach(function(p) {
      d = d.replace(p, "")
    })), d
  }
  ...
  var Q = function() {
    function a() {
      ...
      g.loaded ? y.body.appendChild(d) : (document.head.appendChild(d), d.disabled = !0, o.push(d)), u.set(this, {
        adopters: new Map,
        actions: [],
        basicStyleElement: d
      })
    ...
    var c = a.prototype;
    return c.replace = function(p) {
      var _ = _e(p);
      try {
        if (!u.has(this)) throw new TypeError(Z);
        var v = u.get(this),
          m = v.basicStyleElement;
        return m.innerHTML = _, me(this), Promise.resolve(this)
      } catch (S) {
        return Promise.reject(S)
      }
    }, c.replaceSync = function(p) {
      var _ = _e(p);
      if (!u.has(this)) throw new TypeError(Z);
      var v = u.get(this),
        m = v.basicStyleElement;
      return m.innerHTML = _, me(this), this
    }, e(a, [{
      key: "cssRules",
      get: function() {
        if (!u.has(this)) throw new TypeError(Z);
        var p = u.get(this),
          _ = p.basicStyleElement;
  ...
  function X(a) {
    for (var c = document.createDocumentFragment(), d = ge(a), p = $.get(a), _ = 0, v = d.length; _ < v; _++) {
      var m = u.get(d[_]),
        S = m.adopters,
        k = m.basicStyleElement,
        b = S.get(a);
      b ? (p.disconnect(), c.appendChild(b), (!b.innerHTML || b.sheet && !b.sheet.cssText) && (b.innerHTML = k.innerHTML), p.observe()) : (b = document.createElement("style"), b.innerHTML = k.innerHTML, l.set(b, a), f.set(b, 0), S.set(a, b), c.appendChild(b)), a === document.head && i.push(b)
    }
  ...
  function Ge(a, c) {
    for (var d = ge(a), p = 0, _ = c.length; p < _; p++)
      if (!(d.indexOf(c[p]) > -1)) {
        var v = u.get(c[p]),
          m = v.adopters,
          S = $.get(a),
  ...
  function Ve(a) {
    if (!!document)
      for (var c = 0, d = a.length; c < d; c++) {
        for (var p = a[c], _ = p.addedNodes, v = p.removedNodes, m = 0, S = v.length; m < S; m++) {
          var k = l.get(v[m]);
          k && X(k)
        }
        if (!t)
          for (var b = 0, B = _.length; b < B; b++)
            for (var te = document.createNodeIterator(_[b], NodeFilter.SHOW_ELEMENT, function(oe) {
                var R = h.get(oe);
  ...
  function be() {
    ...
    a.hidden = !0, document.body.appendChild(a), y.body = a.contentWindow.document.body, y.CSSStyleSheet = a.contentWindow.CSSStyleSheet, ve(a.contentWindow.CSSStyleSheet.prototype), we(document.body), g.loaded = !0;
    for (var c = document.createDocumentFragment(), d = 0, p = o.length; d < p; d++) o[d].disabled = !1, c.appendChild(o[d]);
    y.body.appendChild(c);
    for (var _ = 0, v = i.length; _ < v; _++) c.appendChild(i[_]);
  ...
  function Ne() {
    var a = {
      ...
      set: function(p) {
        var _ = s.get(this) || [];
        je(p, this);
        var v = this === document ? fe() ? this.head : this.body : this,
          m = "isConnected" in v ? v.isConnected : document.body.contains(v);
    ...
    if (Object.defineProperty(Document.prototype, "adoptedStyleSheets", a), typeof ShadowRoot < "u") {
      ...
      Element.prototype.attachShadow = function() {
        ...
        return h.set(this, d), we(d), d
      }, Object.defineProperty(ShadowRoot.prototype, "adoptedStyleSheets", a)
    }
  }
  ve(P.prototype), window.CSSStyleSheet = Q, Ne(), fe() ? document.addEventListener("DOMContentLoaded", be) : be()
})();
...
let C = class extends V {
  ...
  fetchWithTimeout(n, e = {}, t = 5e3) {
    ...
    return setTimeout(() => {
      ...
      .catch(r => {
        throw r.name === "AbortError" ? new Error("Response timed out") : new Error(r.message)
      })
  }
  async _getAd() {
    var n;
...
A([pe()], C.prototype, "_pqData", 2);
A([pe()], C.prototype, "_showNewDesign", 2);
A([pe()], C.prototype, "_showBanner", 2);
A([gt("#tooltip")], C.prototype, "tooltip", 2);
C = A([ut("banner-ads")], C);